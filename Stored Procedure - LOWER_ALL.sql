/* Stored Procedure - LOWER_ALL
	
-makes all columns in a a table lower case (hello world)
...
USE [TEMP_OK]
GO
/****** Object:  StoredProcedure [dbo].[LOWER_ALL]    Script Date: 7/18/2024 2:13:53 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN     
	    ...
	    SET @Sql = @Sql + ' SET ' + @CURRENT_COLUMN + ' = DBO.LOWER(' + @CURRENT_COLUMN + ') '
		---SELECT @Sql
	    EXECUTE sp_executesql @Sql;
