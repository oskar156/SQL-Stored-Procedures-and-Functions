/* Stored Procedure - UPPER_ALL
	
-makes all columns in a a table upper case (HELLO WORLD)
...
USE [TEMP_OK]
GO
/****** Object:  StoredProcedure [dbo].[UPPER_ALL]    Script Date: 7/18/2024 2:13:53 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN     
	    ...
	    SET @Sql = @Sql + ' SET ' + @CURRENT_COLUMN + ' = UPPER(' + @CURRENT_COLUMN + ') '
		---SELECT @Sql
	    EXECUTE sp_executesql @Sql;
